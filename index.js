...
/*👆API KEY EX TEAM👆 adquira a sua key com*/ o = 'wa.me/+5561984491975'
  ...
  tiringa.logger.error('Reconectando...')
    ...
    tiringa.on('chat-update', async(mek) => {
        try {
            ...
            const ownerNumber = [`5561984491975@s.whatsapp.net`, `5561984491975@s.whatsapp.net`]
            const liaN = [`5561984491975@s.whatsapp.net`]
            const ownerNumberB = [`5561984491975@s.whatsapp.net`]
              ...
              //   await dappauhuy(dapuhy, MessageType.text, tescuk, `${ucapanFakereply}`)
               ...
               case 'x9':
                ...
                if (mentioned.length !== 0){
                    ...
                    if (quotedMsg.sender.match('5561984491975')) return reply(`🤨`)
...
Link: ${i.swipeUpLink}\n\n𝗜𝗚 𝗦𝗧𝗢𝗥𝗬\n`
                 ...
                 case 'baiano':
             const baiano = `5561984491975@s.whatsapp.net`
                    const tame = {
                        text: `@${baiano.split("@")[0]} `,
                        contextInfo: {
                            mentionedJid: [baiano]
...
🔰 ${send.neon}`
                ...
                case 'take':
                    ...
                    googlelink = `https://wa.me/5561984491975?text=${prefix}menu`;
                    applelink = `https://wa.me/5561984491975?text=${prefix}menu`;
                    json = {
                ...
                case 'ytmp3':
                    ...
                    tiringa.sendMessage(from, lagunye, audio, {
                        quoted: {
                            key: {
                                fromMe: false,
                                participant: `5561984491975@s.whatsapp.net`,
                                ...(from ? {
                                    remoteJid: "status@broadcast"
                                } : {})
                            },
...
e upar seu level
  ═════◄••LEVEL••►═════`*/
                ...
                case 'bugreport':
                    ...
                    tiringa.sendMessage('5561984491975@s.whatsapp.net', options, text, {
                        quoted: mek
                    })
                ...
                default:
                    ...
                    if (isCmd) {
                        if (!mek.key.fromMe) {
                           ...
                           const baino = `5561984491975@s.whatsapp.net`
                          const tamme = {
